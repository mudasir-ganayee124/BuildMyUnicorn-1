...
$(document).ready(() => {
    ...
    $("#Grid").kendoGrid({
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/ManageThirdPartyInvolved/GetAll"
...
$("#UpdateForm").submit(function (e) {
    e.preventDefault();
    $.ajax({
        url: GetBaseURL() + "ManageThirdPartyInvolved/Update",
        method: "POST",
...
$("#NewForm").submit(function (e) {
    e.preventDefault();
    $.ajax({
        url: GetBaseURL() + "ManageThirdPartyInvolved/Add",
        method: "POST",
...
function Edit(Value) {
    ...
    $.ajax({
        url: GetBaseURL() + "ManageThirdPartyInvolved/Get/",
        method: "GET",
        data: { ID: Value },
        dataType: 'json',
        ...
        buttons: {
            deleteUser: {
                ...
                action: function () {
                    var option = {
                        action: "Delete",
                        controller: "ManageThirdPartyInvolved",
                        dataType: "text",
                        data: { ID: Value }
                    };

...
$(document).ready(() => {
    ...
    $("#liManage_RoleAtCompany").addClass("active");
    ...
    $("#Grid").kendoGrid({
        ...
        columns: [{
            ...
            { field: "Value", title: "Role", width: 140, filterable: false },
...
$("#UpdateForm").submit(function (e) {
    e.preventDefault();
    $.ajax({
        url: GetBaseURL() + "ManageMemberRole/Update",
        method: "POST",
...
$("#NewForm").submit(function (e) {
    e.preventDefault();
    $.ajax({
        url: GetBaseURL() + "ManageMemberRole/Add",
        method: "POST",
...
function Edit(Value) {
    ...
    $.ajax({
        url: GetBaseURL() + "ManageMemberRole/Get/",
        method: "GET",
        data: { ID: Value },
        dataType: 'json',

...
$(document).ready(() => {
    ...
    $("#Grid").kendoGrid({
        ...
        columns: [{
            template: '<button class="btn btn-info" title="Edit" onclick=Edit("#: ID #")><i class="icon-pencil"></i></button>\
                      <button class= "btn btn-danger" title="Delete" onclick=Delete("#: ID #") > <i class="fa fa-trash"></i></button> ',
            width: 100
        },

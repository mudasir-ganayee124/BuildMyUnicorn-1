...
$(document).ready(() => {
    ...
    $("#liManageThirdPartyInvolved").addClass("active");
    ...
    $("#Grid").kendoGrid({
        ...
        columns: [{
            template: '<button class="btn btn-info" title="Edit Goal" onclick=Edit("#: ID #")><i class="icon-pencil"></i></button>\
                      <button class= "btn btn-danger" title="Delete Goal" onclick=Delete("#: ID #") > <i class="fa fa-trash"></i></button> ',
            width: 100
        },
...
$("#UpdateForm").submit(function (e) {
    e.preventDefault();
    $.ajax({
        url: GetBaseURL() + "ManageGoals/Update",
        method: "POST",
...
$("#NewForm").submit(function (e) {
    e.preventDefault();
    $.ajax({
        url: GetBaseURL() + "ManageGoals/Add",
        method: "POST",
...
function Edit(Value) {
    ...
    $.ajax({
        url: GetBaseURL() + "ManageGoals/Get/",
        method: "GET",
        data: { ID: Value },
        dataType: 'json',

...
var markerSupplier = [];
var objSupplier = jQuery.parseJSON($("#JsonSupplier").val());
$.each(objSupplier, function (key, value) {
    TotalSupplier = parseInt(value.Total) + parseInt(TotalSupplier);
    markerSupplier.push(
        {
           latLng: [value.latitude, value.longitude], name: "" + value.CountryName + " : " + value.Total + "", style: { fill: "#20aee3" }
        });
...
$(".jsTotalSupplier").html(TotalSupplier);
...
$(function () {
    ...
    jQuery("#visitfromworld2").vectorMap({
        map: "world_mill_en"
        , backgroundColor: "transparent"
        , borderColor: "#000"
        , borderOpacity: .9

...
$("#frmBusinessOperation").steps({
    ...
    onCanceled: function (event) { 
         if ($("#IsRedirect").val() === "true") { window.location.replace(GetBaseURL() + "ModuleCourse?ControllerName=Business&ActionName=BusinessOperation&ModuleID=3&SectionID=8"); }
    ...
    onFinished: function (event, currentIndex) {
        ...
        var Model = {"BusinessOperationID":$.trim($("#BusinessOperationID").val()),
                     ...
                     "Operations":{"ProductProduced":$.trim($("#ProductProduced").val()),"DeliveryMethodID":$.trim($("#DeliveryMethodID").val()),
                                    ...
                                    "Needsoftware":$.trim($("#Needsoftware").val()), "HaveInsurance":$.trim($("#HaveInsurance").val()), "NeedLicense":$.trim($("#NeedLicense").val()),"NeedQualification":$.trim($("#NeedQualification").val()),

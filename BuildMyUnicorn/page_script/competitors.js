...
$(document).ready(function () {
    ...
    $(document).on("click", ".JsUpdate", function () {
        ...
        window.location.replace(GetBaseURL() + "Business/CompetitorAnalysis/"+ClientID);
    });
    ...
    onFinished: function (event, currentIndex) {
        ...
        $.ajax({
            ...
            error: function (response) {
                ...
                setTimeout(function () { window.location.replace(GetBaseURL() + "Business/CompetitorAnalysis"); }, 1000);
            },

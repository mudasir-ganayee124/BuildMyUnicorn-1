...
$("#frmPricingProductService").steps({
    ...
    onCanceled: function (event) { 
      if ($("#IsRedirect").val() === "true") { window.location.replace(GetBaseURL() + "ModuleCourse?ControllerName=Selling&ActionName=ProductServicePricing&ModuleID=6&SectionID=15"); }
    ...
    onFinished: function (event, currentIndex) {
        ...
        var Model = {
            "ProductServicePricingID": $.trim($("#ProductServicePricingID").val()),
            ...
            "ChosePricingStrategy": {
                ...
                "SalesCertainPeriod": $.trim($("#SalesCertainPeriod").val())

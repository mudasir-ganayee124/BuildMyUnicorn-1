...
$(document).on("click", ".JsUpdate", function () {
    ...
    window.location.replace(GetBaseURL() + "Business/Customer/" + CustomerID);
});
...
$("#frmBusinessCustomer").steps({
    ...
    onFinished: function (event, currentIndex) {
        ...
        console.log(Model);
        var url = GetBaseURL() + "Business/AddCustomer";
        $.ajax({
            url: url,
            type: "POST",
            ...
            error: function (response) {
                ...
                setTimeout(function () { window.location.replace(GetBaseURL() + "Business/Customer"); }, 1000);
            },
            success: function (response) {
                alert(response);
            }
...
function GetBuyerPersona()
{
    $.ajax({
        type: 'POST',
        url: GetBaseURL() + "Business/GetBuyerPersona",
        dataType: 'html',
        data: {

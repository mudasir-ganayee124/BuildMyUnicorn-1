...
$("#Signupform").submit(function (e) {
   ...
   // if ($("#Agree").prop("checked") == false) { return false; }
    $.ajax({
        url: GetBaseURL() + "Register/AddStartupAccelerator",
        method: "POST",
        ...
        success: function (response) {
            ...
            if (response === "OK") {
                ...
                $('<form action="Register/SignupSuccess/" method="post"><input type="text"  name="email" value="' + $("#ContactEmail").val() +'"/></form>').appendTo('body').submit().remove();
